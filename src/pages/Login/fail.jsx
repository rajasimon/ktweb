...
export const Fail = () => {
  ...
  return (
    <div className="flex flex-col items-center space-y-6">
      ...
      <Alert icon={danger} isDanger={true} subtitle="Ensurevnice your face is well-lit and unobstructed. Try again by looking directly at the camera. If the issue persists, consider adjusting your position or lighting conditions. If problems persist, please contact support for assistance." />
